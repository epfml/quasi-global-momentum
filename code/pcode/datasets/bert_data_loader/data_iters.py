...
from pcode.datasets.bert_data_loader.bert_formatting import (
    glue_example_to_feature,
    tagging_example_to_feature,
    multiplechoice_example_to_feature,
)
from pcode.datasets.bert_data_loader.glue.datasets import *
from pcode.datasets.bert_data_loader.reading_compr.datasets import *
from pcode.datasets.bert_data_loader.tagging.datasets import *
from pcode.datasets.bert_data_loader.textcls.text_classification import *
from pcode.datasets.bert_data_loader.semeval.datasets import *
from pcode.datasets.bert_data_loader.ner.datasets import *


task2datadir = {
    "mrpc": "/mlodata1/tlin/dataset/bert/bert_data/glue_data/data/MRPC",
    "sst2": "/mlodata1/tlin/dataset/bert/bert_data/glue_data/data/SST-2",
    "mnli": "/mlodata1/tlin/dataset/bert/bert_data/glue_data/data/MNLI",
    "qqp": "/mlodata1/tlin/dataset/bert/bert_data/glue_data/data/QQP",
    "cola": "/mlodata1/tlin/dataset/bert/bert_data/glue_data/data/CoLA",
    "qnli": "/mlodata1/tlin/dataset/bert/bert_data/glue_data/data/QNLI",
    "rte": "/mlodata1/tlin/dataset/bert/bert_data/glue_data/data/RTE",
    "posptb": "/mlodata1/tlin/dataset/bert/bert_data/tagging/ptb/",
    "swag": "/mlodata1/tlin/dataset/bert/bert_data/reading_compr/swag",
    "squad1": "/mlodata1/tlin/dataset/bert/bert_data/qa/squad/v1.1",
    "agnews": "/mlodata1/tlin/dataset/bert/bert_data/textcls/agnews",
    "trec": "/mlodata1/tlin/dataset/bert/bert_data/textcls/trec",
    "dbpedia": "/mlodata1/tlin/dataset/bert/bert_data/textcls/dbpedia",
    "yelp2": "/mlodata1/tlin/dataset/bert/bert_data/textcls/yelp2",
    "semeval16": "/mlodata1/tlin/dataset/bert/bert_data/semeval/",
    "conll2003": "/mlodata1/tlin/dataset/bert/bert_data/ner/conll2003",
}
